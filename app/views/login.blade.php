  ...
  <body>
    ...
    <div class="container">
      ...
      <form class="form-signin" action="login" method="post">
       ...
       <center> <img src="{{ asset('img/silver_box.png') }}" alt="" /></center><br/>
        <label for="inputEmail" class="sr-only">Email address</label>

          @if (Session::has('login_errors'))
          <center><p style="color:#FB1D1D">El nombre de usuario o la contraseña no son correctos.</p></center>
          @else
              <center><p>Introduzca su usuario y clave para continuar</p></center>
          @endif
...
<span style="color:#000"><center> @include('includes.footer') {{ HTML::link('http://subappstore.zz.mu/','Grupo SUBAPPSOTRE')}}</center></span>
