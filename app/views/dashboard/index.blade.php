...
<div class="navbar navbar-inverse navbar-fixed-top">
    ...
    <div id="sidebar-nav" class="hidden-xs">
        ...
        <ul id="dashboard-menu" class="nav nav-list">
            ...
            <li class=" "><a rel="tooltip" data-placement="right" data-original-title="Blog" href="messages"><i class="icon-envelope"></i> <span class="caption">Mensajes</span></a></li>
...
<div class="row">
    ...
    <div class="col-sm-4 sidebar">
        ...
        <footer>
            ...
            <p>&copy; 2015 <a href="http://www.arielmax.com.ar">www.arielmax.com.ar</a></p>
        </footer>
